...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_500_get_categories_failed(self):
    ...
    def test_404_get_questions_by_categories_not_found(self):
        res = self.client().get('/categories/124/questions')
        data = json.loads(res.data)
    ...
    def test_404_get_quizzes_not_found(self):
